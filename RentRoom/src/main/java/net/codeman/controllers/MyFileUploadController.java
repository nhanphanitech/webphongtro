...
import net.codeman.models.MyUploadForm;
...
public class MyFileUploadController {
   ...
   private String doUpload(HttpServletRequest request, Model model, //
       ...
       String uploadRootPath = "C:\\SpringWebTool\\apache-tomcat-9.0.59-windows-x64\\apache-tomcat-9.0.59\\wtpwebapps\\uploadimg";
   ...
   public String upload(ModelMap model, @RequestParam MultipartFile image) {
	   if(image.isEmpty()) {
